...
- This allows programmers to write a game once, yet work on multiple machine architectures. 
...
- Game development is a slow, sometimes frustrating, process while also a rewarding processing.
...
Our first game will be Brick Breaker.
